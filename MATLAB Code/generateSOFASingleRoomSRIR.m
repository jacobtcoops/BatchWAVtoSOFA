function [SOFA] = generateSOFASingleRoomSRIR(totalSources, sourceNumber,...
    listenerPos, sourcePos, SRIRPath, outputPath, outputFileName)
%generateSOFASingleRoomSRIR generates a SOFA file for a set of input audio
%files and coordinates
%   given a list of sound source and listener coordinates, and the path for
%   the SRIRs, a singleRoomSRIR SOFA file will be generated
